...
-- ░██████░░░░░░░░██████░░░░░█████░░░░░░░░█████████░                                                                                  |
--   ░░███████████░░░░░████████░░█████████████░░░░                                                                                    |
--  ( (OO  )            ( OO ).-.                                (  OO) )   ( OO ).  _(  OO)( \( -O )     _(OO  )_  _(  OO)( \( -O )  |
-- _.`     \ ,--.       / . --. /  ,--.   ,--.       .-'),-----. /     '._ (_)---\_)(,------.,------. ,--(_/   ,. \(,------.,------.  |
--(__...--'' |  |.-')   | \-.  \    \  `.'  /       ( OO'  .-.  '|'--...__)/    _ |  |  .---'|   /`. '\   \   /(__/ |  .---'|   /`. ' |
-- |  /  | | |  | OO ).-'-'  |  | .-')     /        /   |  | |  |'--.  .--'\  :` `.  |  |    |  /  | | \   \ /   /  |  |    |  /  | | |
-- |  |_.' | |  |`-' | \| |_.'  |(OO  \   /         \_) |  |\|  |   |  |    '..`''.)(|  '--. |  |_.' |  \   '   /, (|  '--. |  |_.' | |
...
-- Nota: Se você quiser usar a pasta datapack canary (personalizada), coloque apenas "data-canary"
-- Se você quiser usar a pasta datapack global, coloque "data-otservbr-global"
-- Se "useAnyDatapackFolder" estiver definido como true, você pode escolher qualquer pasta datapack para seu servidor
useAnyDatapackFolder = false
dataPackDirectory = "data-otservbr-global"
-- Não mude isso a menos que você saiba o que está fazendo
coreDirectory = "data"
...
-- Cast system
-- NOTE: set experience to 0 to deactivate the bonus
castExperienceMultiplier = 15;
maximumViewersPerCast = 50;
-- NOTE: set experience to 1.0 to deactivate the bonus, example of use: 1.15 (15% of bonus)
castExperienceMultiplier = 1.15
maximumViewersPerCast = 50
...
serverMotd = "Welcome to the Play Otserver!"
...
mysqlHost = "127.0.0.1"
mysqlUser = "play"
mysqlPass = "@QtMYniWVprP/[lu"
mysqlDatabase = "global2024"
mysqlPort = 3306
mysqlSock = ""
passwordType = "sha1"
...
coinPacketSize = 25
coinImagesURL = "http://189.5.38.76/images/store/"
...
ownerName = "Play Otserver"
ownerEmail = "sac@playotserver.com.br"
url = "http://playotserver.com.br"
